...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td style="border-style:solid;border-width:1px;text-align:center;vertical-align:middle" rowspan="1">Como fã de RDR2, eu quero acessar uma aba de informações gerais para conhecer ou relembrar a história, os personagens e as mecânicas principais do jogo.</td>
